...
<form action="/searchfilter.php" class="w3-container w3-card-4 w3-light-grey">
   <center> <h2> วาง Url ที่นี่  </h2> </center>
...
$homepage = file_get_contents('https://letsdvl.000webhostapp.com/dl/search.php/?s='.$lloc.''); 
echo $homepage; 
...
<div class="footer">
  ...
  <p> &copy; All right Reserved <?php echo date("Y"); ?> . Powered By <a href="https://www.facebook.com/pncklottobot"><b> PNCK@SKT </b> </a></p>
</div>
  </p>
</div>
